...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'CHG华夏文明降临', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '家族网站', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://r2.zako.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'CHG,华夏文明降临,韩少麒,音速觉醒', // 网站关键词 英文逗号隔开
